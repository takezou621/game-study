...
| ファイル | 説明 |
|---------|------|
| [docs/USECASES.md](docs/USECASES.md) | ユースケース仕様書（100以上のシナリオ定義） |
| [tasks/lessons.md](tasks/lessons.md) | 開発パターン・教訓の記録 |
| [tasks/todo.md](tasks/todo.md) | 実装状況・レビュー記録 |

### テスト構成

| カテゴリ | テスト数 | 説明 |
|---------|---------|------|
| Unit Tests | ~850 | 各モジュールの単体テスト |
| Integration Tests | ~100 | モジュール間連携テスト |
| Use Case Tests | 104 | USECASES.mdに基づくシナリオテスト |
| Simulation Tests | 6 | 学生-教師シミュレーションテスト |
| **Total** | **1058** | カバレッジ: **81%** |
